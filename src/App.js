...
const [faClosed, setFaClosed] = useState(<FontAwesomeIcon icon={faSearch} />)

const changeFont = () =>{
  setFaClosed(<FontAwesomeIcon icon={faTimes} />)
}
...
return ( 
  ...
  search={<FontAwesomeIcon icon={faSearch} onClick={visible}/>}
  isClosed={isClosed}/>
